            ...
            <article class="col-sm-9 maincontent">
                ...
                <br>
                    <form method="POST" action="{{ route('contact.store') }}">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <input name="nom" class="form-control"  type="text" placeholder="Name" value="{{ old('name') }}">
                            </div>
                            <div class="col-sm-4">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <textarea name="msg" value="{{ old('msg') }}"  placeholder="Type your message here..." class="form-control" rows="9"></textarea>
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            ...
                            <div class="col-sm-6 text-right">
                                <button class="btn btn-action" type="submit" value="Send message"> send
                                </button>
                            </div>
                        </div>
                    </form>
